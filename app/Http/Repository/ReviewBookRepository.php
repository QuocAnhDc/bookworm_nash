...
{
    public function indexReview($book)
    {
        try {
    ...
    public function storeReview(Request $request, $book)
    {
        try {
    ...
    public function showReviewOfBook($book, $review)
    {
        try {
            $bookDetail = Book::detail()->findOrFail($book);
            $bookDetail = new DetailBookResource($bookDetail);
    ...
    public function filterReview(Request $request, $book)
    {
        try {
            $params = $request->all();
